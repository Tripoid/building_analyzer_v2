...
const IMAGE_META = [
  ...
  { type: 'restoration', title: 'Реставрация фасада', desc: 'Многопроходная реставрация: LaMa (трещины/пятна), заливка штукатурки (кладка/сколы), синтез стекла (повреждённые окна)' },
]
