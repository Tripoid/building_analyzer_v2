...
MATERIAL_RATES = {
    # Prices sourced from Russian retail (Leroy Merlin / OBI / Stroymarket, 2024)
    "crack_surface": [
        ("facade_putty", "Шпатлёвка фасадная", "кг", 0.3, 450),
        ("primer_deep", "Грунтовка глубокого проникновения", "л", 0.15, 200),
        ("paint_facade", "Краска фасадная", "л", 0.25, 550),
    ],
    "crack_deep": [
        ("repair_compound", "Ремонтный состав (цементный)", "кг", 1.5, 380),
        ("reinforcing_mesh", "Армирующая сетка фасадная", "м²", 1.1, 85),
        ("primer_deep", "Грунтовка глубокого проникновения", "л", 0.15, 200),
        ("facade_putty", "Шпатлёвка фасадная", "кг", 0.5, 450),
        ("paint_facade", "Краска фасадная", "л", 0.25, 550),
    ],
    "peeling": [
        ("cement_plaster", "Штукатурка цементная фасадная", "кг", 14.0, 50),
        ("reinforcing_mesh", "Армирующая сетка фасадная", "м²", 1.1, 85),
        ("primer_deep", "Грунтовка глубокого проникновения", "л", 0.2, 200),
        ("facade_putty", "Шпатлёвка фасадная", "кг", 0.8, 450),
        ("paint_facade", "Краска фасадная", "л", 0.25, 550),
    ],
    "exposed_brick": [
        ("cement_plaster", "Штукатурка цементная фасадная", "кг", 14.0, 50),
    ...
    "water_damage": [
        ("waterproof_compound", "Гидроизоляционный состав", "кг", 1.0, 650),
        ("primer_deep", "Грунтовка глубокого проникновения", "л", 0.2, 200),
        ("cement_plaster", "Штукатурка цементная фасадная", "кг", 2.5, 50),
        ("paint_facade", "Краска фасадная", "л", 0.25, 550),
    ],
    "efflorescence": [
        ("anti_salt", "Антисоль (очиститель высолов)", "л", 0.3, 380),
        ("hydrophobizer", "Гидрофобизатор фасадный", "л", 0.25, 420),
    ],
    "moss": [
        ("antiseptic", "Антисептик фасадный (биозащита)", "л", 0.3, 320),
        ("primer_deep", "Грунтовка глубокого проникновения", "л", 0.15, 200),
        ("paint_facade", "Краска фасадная", "л", 0.25, 550),
    ],
    "rust": [
        ("rust_converter", "Преобразователь ржавчины", "л", 0.15, 380),
        ("anticorrosion_primer", "Грунт антикоррозийный", "л", 0.12, 320),
        ("paint_facade", "Краска фасадная", "л", 0.25, 550),
    ],
    "spalling": [
        ("repair_compound", "Ремонтный состав (цементный)", "кг", 2.0, 380),
        ("reinforcing_mesh", "Армирующая сетка фасадная", "м²", 1.1, 85),
        ("primer_deep", "Грунтовка глубокого проникновения", "л", 0.2, 200),
        ("facade_putty", "Шпатлёвка фасадная", "кг", 0.8, 450),
        ("paint_facade", "Краска фасадная", "л", 0.25, 550),
    ...
    "broken_glass": [
        ("glass_unit", "Стеклопакет двухкамерный", "шт", 0.67, 7500),  # ~1 шт на 1.5 м²
        ("sealant", "Герметик силиконовый", "шт", 0.67, 350),
    ],
    "damaged_wood": [
        ("wood_antiseptic", "Антисептик для дерева", "л", 0.15, 320),
        ("wood_putty", "Шпатлёвка по дереву", "кг", 0.5, 280),
        ("wood_paint", "Краска/лак по дереву", "л", 0.15, 650),
    ],
    "rusty_metal": [
        ("rust_converter", "Преобразователь ржавчины", "л", 0.2, 380),
        ("anticorrosion_primer", "Грунт антикоррозийный", "л", 0.15, 320),
        ("metal_paint", "Краска по металлу", "л", 0.12, 520),
    ],
    "damaged_railing": [
        ("rust_converter", "Преобразователь ржавчины", "л", 0.2, 380),
        ("anticorrosion_primer", "Грунт антикоррозийный", "л", 0.15, 320),
        ("metal_paint", "Краска по металлу", "л", 0.12, 520),
        ("welding_materials", "Сварочные материалы", "комп", 0.1, 4500),
    ],
}

# Labor rates per defect type: (display_name, unit, rub_per_unit, norm_hours_per_unit)
LABOR_RATES = {
...
SCAFFOLDING_COST_PER_FLOOR = 45000  # RUB per floor for full facade access
